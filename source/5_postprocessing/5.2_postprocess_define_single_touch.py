...
if __name__ == "__main__":
    ...
    for session in sessions:
        ...
        for data_filename_abs, data_filename in zip(files_abs, files):
            ...
            filename_output_abs = data_filename_abs.replace(".csv", ".txt")
            ...
            # 3.2 split by touch event
            splitter = SemiControlledDataSplitter()  # tools
            data_sliced, endpoints = splitter.split_by_touch_event(scd, correction=True,
                                                                   show=show, show_single_touches=show_single_touches,
                                                                   manual_check=manual_check,
                                                                   save_visualiser=save_figures,
                                                                   save_visualiser_fname=output_img_filename, viz=viz)
