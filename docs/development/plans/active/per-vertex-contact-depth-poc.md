...
- code/scripts/_3_preprocessing/_4_somatosensory_quantification/poc_contact_depth_field.py
- code/src/preprocessing/motion_analysis/tactile_quantification/gui/__init__.py
- code/src/preprocessing/motion_analysis/tactile_quantification/gui/contact_depth_field_viewer.py
- code/src/preprocessing/motion_analysis/tactile_quantification/model/contact_depth_field.py
...
- docs/development/brainstorms/per-vertex-contact-depth.md
- docs/development/plans/active/per-vertex-contact-depth-poc.md
