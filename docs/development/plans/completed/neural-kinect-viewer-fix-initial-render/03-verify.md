...
```bash
rm docs/development/knowledge-base/bug-neural-kinect-viewer-initial-render.md
```
...
```bash
mv docs/development/plans/active/fix-initial-render.md docs/development/plans/completed/
mv docs/development/plans/active/neural-kinect-viewer-fix-initial-render/ docs/development/plans/completed/
```
