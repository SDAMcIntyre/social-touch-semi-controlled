...
**Dependencies:** None
**Can parallelize:** YES
**Detail:** `docs/development/plans/active/neural-kinect-viewer/01-foundation.md`
...
**Can parallelize:** YES
**Detail:** `docs/development/plans/active/neural-kinect-viewer/02-core.md`
...
**Can parallelize:** NO
**Detail:** `docs/development/plans/active/neural-kinect-viewer/03-integration.md`
...
**Dependencies:** Group 5
**Can parallelize:** NO
**Detail:** `docs/development/plans/active/neural-kinect-viewer/04-entry-point.md`
...
See `docs/development/plans/active/neural-kinect-viewer/04-entry-point.md` for full test checklist.
