...
`docs/development/knowledge-base/bug-neural-kinect-viewer-initial-render.md`
...
**Detail:** `docs/development/plans/active/neural-kinect-viewer-fix-initial-render/01-primary-fix.md`
...
**Detail:** `docs/development/plans/active/neural-kinect-viewer-fix-initial-render/02-bounding-proxy.md`
...
**Detail:** `docs/development/plans/active/neural-kinect-viewer-fix-initial-render/03-verify.md`
...
| File | Phase |
|---|---|
| `docs/development/knowledge-base/bug-neural-kinect-viewer-initial-render.md` | 3 |
