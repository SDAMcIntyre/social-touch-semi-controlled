...
transformer utilities (:func:`transform_unified_csv`,
:func:`transform_spatial_columns_in_place`) that apply pre-computed rigid
transforms to somatosensory contact data, and an interactive parameter
