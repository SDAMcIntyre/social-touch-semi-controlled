...
# Thin entry point for processing-only analysis tasks.
# All flow logic lives in analysis_workflow.py; this script imports and calls it
# with mode="processing" so that only tasks with category "processing" run.
import sys
import argparse
import logging
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description=(
            ...
            "Runs tasks with category 'processing' from the given DAG config. "
