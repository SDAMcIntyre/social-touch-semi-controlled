...
def generate_led_roi(
    ...
    """
    # 1. Prerequisite Check for the manually generated metadata file.
    if not metadata_path.exists():
        error_message = (
            f"Metadata file not found at '{metadata_path}'.\n"
            "This file is generated by the manual pipeline script and is required to proceed.\n"
            "Please run the manual selection script first."
        )
        from utils.pipeline.pipeline_dependency_error import PipelineDependencyError
        raise PipelineDependencyError(error_message, "manual (prepare LED tracking)")
