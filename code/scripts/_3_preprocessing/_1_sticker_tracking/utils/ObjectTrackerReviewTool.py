...
class ObjectTrackerReviewTool:
    ...
    def __init__(self, video_source, tracking_history=None, landmarks=None, landmark_properties=None, *, as_bgr=True, title="Loaded Frames Review"):
        """
