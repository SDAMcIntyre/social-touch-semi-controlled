...
def view_ellipse_tracking(
    ...
    for name in colorspace_manager.colorspace_names:
        ...
        ellipse_object_fit = ellipse_manager._results[name]
        ...
        gui = EllipseFitViewGUI(
            ellipse_df={name: ellipse_object_fit},
            frames=frames_grayscale_squeezed,
            default_threshold=current_colorspace.threshold,
            title=f"Ellipse Visualization for {name}",
            windowState='normal'
            )
        gui.start()
...
if __name__ == '__main__':
    video_path = Path('F:/liu-onedrive-nospecial-carac/_Teams/Social touch Kinect MNG/data/semi-controlled/2_processed/kinect/2022-06-15_ST14-01/block-order-07/handstickers/2022-06-15_ST14-01_semicontrolled_block-order07_kinect_handstickers_corrmap.mp4')
    md_path = Path('F:/liu-onedrive-nospecial-carac/_Teams/Social touch Kinect MNG/data/semi-controlled/2_processed/kinect/2022-06-15_ST14-01/block-order-07/handstickers/2022-06-15_ST14-01_semicontrolled_block-order07_kinect_handstickers_colorspace_metadata.json')
    tracking_ellipses_path = Path('F:/liu-onedrive-nospecial-carac/_Teams/Social touch Kinect MNG/data/semi-controlled/2_processed/kinect/2022-06-15_ST14-01/block-order-07/handstickers/2022-06-15_ST14-01_semicontrolled_block-order07_kinect_handstickers_ellipses.csv')
    view_ellipse_tracking(video_path, md_path, tracking_ellipses_path)
