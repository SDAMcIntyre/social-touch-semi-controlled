...
from .utils.ColorCorrelationVisualizer import ColorCorrelationVisualizer
...
def generate_color_correlation_videos(
    video_path: str,
    md_path: str,
    output_path: str,
    *,
    ...
    for name in object_names:
        ...
        current_metadata = metadata[name]
